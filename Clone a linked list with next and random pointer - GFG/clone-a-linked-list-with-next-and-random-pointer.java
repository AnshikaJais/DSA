...
class Clone {
    ...
    Node copyList(Node head) {
        ...
        // Step 1) Inserting new duplicate node after every curr node
        
        while(curr != null){
            
            Node duplicateNode = new Node(curr.data);
            duplicateNode.next = curr.next;
            curr.next = duplicateNode;
            
            curr = curr.next.next;
        }
        
        // Step 2)  Add Arbitrary pointer to every duplicate Node
        ...
        // Step 3) Parting original and copied list
        
        Node originalHead = head, copiedHead = head.next;
        Node originalCurr = head, copiedCurr = head.next;
        
        while(originalCurr != null){
            
            originalCurr.next = copiedCurr.next;
            
            if(originalCurr.next != null){
                
                copiedCurr.next = originalCurr.next.next;
